...
func setupRoutes(appServer *AppServer) *gin.Engine {
	...
	api := router.Group("/api/v1")
	{
		...
		api.GET("/scheduler/accounts", appServer.recommendAccountsHandler)
		api.POST("/scheduler/accounts", appServer.recommendAccountsHandler)
		api.POST("/publish/stage_images", appServer.stageImagesHandler)
