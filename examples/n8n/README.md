# N8N 接入 xiaohongshuritter 完整指南

## 📋 概述

本文档详细介绍了如何部署汉化版 n8n 工作流平台，并集成 xiaohongshuritter 服务，实现自动化小红书内容发布功能。

## 🚀 环境准备

### 前置要求
- Docker 和 Docker Compose 已安装
- xiaohongshuritter 服务已正常启动
- 有效的 DeepSeek API 密钥
...
## 🔌 接入 xiaohongshuritter 服务

### 前提条件
确保 xiaohongshuritter 服务已正常启动并运行
...
2. **修改连接设置**
   - 将 IP 地址修改为你实际的 xiaohongshuritter 服务 IP
   - 默认导入所有可用的工具函数
...
1. **连接失败**：检查 xiaohongshuritter 服务是否正常运行
...
通过以上步骤，您已成功部署汉化版 n8n 并集成 xiaohongshuritter 服务，可以开始自动化小红书内容发布工作了！